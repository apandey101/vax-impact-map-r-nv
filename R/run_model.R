...
run_model <- function() {
  ...
  ## Calculate severe vaccine adverse events (direct, non-transmission; from vaccinations administered)
  # --------------------------------------------------------------------------
  read_path_calculate_vaccine_adverse_events_r <- here("R/calculate_vaccine_adverse_events.R")
  source(read_path_calculate_vaccine_adverse_events_r)
  df_model_data <- calculate_vaccine_adverse_events(df_model_data)
